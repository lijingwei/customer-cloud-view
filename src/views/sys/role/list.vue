<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button v-has="'sys_role_add'" type="primary" size="small" icon="el-icon-edit" @click="handleCreate()">新建角色</el-button>
    </div>
    ...
    <el-table v-loading.body="listLoading" :data="list" border fit highlight-current-row style="width: 100%">
      ...
      <el-table-column align="center" label="操作" width="200">
        <template slot-scope="scope">
          <el-button v-has="'sys_role_update'" type="primary" size="small" icon="el-icon-edit" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button v-has="'sys_role_delete'" type="danger" size="small" @click="deleteData(scope.$index,list,scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="postForm" :rules="rules" :model="postForm" label-position="right" label-width="100px" style="width: 100%; margin-left:50px;">
        <el-form-item label="角色名称" prop="name">
          <el-input v-model="postForm.name" style="width:70%;"/>
        </el-form-item>
        <el-form-item label="角色标识" prop="key">
          <el-input v-model="postForm.key" style="width:70%;"/>
        </el-form-item>
        <el-form-item label="描述" prop="description">
          <el-input v-model="postForm.description" style="width:70%;"/>
        </el-form-item>
        ...
        <el-form-item label="数据权限" prop="menus">
          <el-tree
            ref="deptAddTree"
            :data="deptTree"
            :props="deptTreeProps"
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button v-has="'sys_role_add'" v-loading="loading" v-if="dialogStatus == 'create'" type="primary" @click="createData">确定</el-button>
        <el-button v-has="'sys_role_update'" v-loading="loading" v-else-if="dialogStatus == 'update'" type="primary" @click="updateData">确定</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
     ...
     */
    getDeptIds() {
      return this.$refs.deptAddTree.getCheckedKeys().concat(this.$refs.deptAddTree.getHalfCheckedKeys())
    },
    /**
    ...
    handleUpdate(row) {
      ...
      get(row.id).then(response => {
        this.setDeptIds(response.data.menus)
      })
      this.$nextTick(() => {
        this.$refs['postForm'].clearValidate()
      })
